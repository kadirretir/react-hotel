...
import singleRoomScss from './singleroom.module.scss';
        ...
        <>
            {myHotel.filter(filterHotel => filterHotel.title.replace(/\s+/g, '').includes(match.params.id)).map((singleHotel) => (
                <React.Fragment key={singleHotel.id}>
                    <section id={singleRoomScss.singleroom} style={{ backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.7)),url(${singleHotel.hotel_img})` }}>
                        <div className={singleRoomScss.container}>
                            <div className={singleRoomScss.hero_content}>
                    ...
                    <section id={singleRoomScss.features}>
                        <div className={singleRoomScss.container}>
                            <div className={singleRoomScss.img_row}>
                            ...
                            <div className={singleRoomScss.singleroom_details_left}>
                                <h2>Otel Hakkında</h2>
                                <p>
                                    {singleHotel.luks
                            ...
                            <div className={singleRoomScss.singleroom_details_right}>
                            ...
                            <div className={singleRoomScss.singleroom_extras}>
